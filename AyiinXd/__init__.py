...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/ferdihardiyansa/Reforestation/master/DEVS.json"
    )
...
UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/ferdihardiyansa/genos-ubot.git")
...
ALIVE_TEKS_CUSTOM = os.environ.get(
    "ALIVE_TEKS_CUSTOM",
    "𝙷𝙴𝚈, 𝚂𝙰𝚈𝙰 𝙿𝙴𝙽𝙶𝙶𝚄𝙽𝙰 genos-ubot")

# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "genos")
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**Genos-Ubot v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
